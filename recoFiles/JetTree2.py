...
def jvars(rootfile, first, last):
    ...
    f.Close()
    #os.system("mv "+"jvars_"+str(first)+"_"+str(last)+"_"+rootfile.split(".")[0]+".npy"+" /gpfs/ddn/users/lgiannini/NN/DataMiniAODNew")
...
#    print t2.shape
    ...
    f.Close()
    #os.system("mv "+"svars"+str(first)+"_"+str(last)+"_"+rootfile.split(".")[0]+".npy"+" /gpfs/ddn/users/lgiannini/NN/DataMiniAODNew")
...
#    tree=f.Get("analyzer1/tree")
    ...
    print time.time()-starttime
    f.Close() 
    #os.system("mv "+"tvars_"+str(first)+"_"+str(last)+"_"+rootfile.split(".")[0]+".npy"+" /gpfs/ddn/users/lgiannini/NN/DataMiniAODNew")
